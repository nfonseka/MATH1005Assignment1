...
In the analysis of US crime, it was deemed important to also analyse the overall trend in violent crime across the country. This is important to ensure that legislation and initiatives by the US government are overall aiming to decrease the rate of violent crimes. The violent crime rate was chosen to be investigaed rather than the total frequency of violent crime as the population of the US also increased over time.
...
#### Homoscedasticity
To investigate homoscedasticity, VCRate less than an arbitraty 500 was selected.
```{r}
